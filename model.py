...
class MyModel(AIxBlockMLBase):
    ...
    def model(self, **kwargs):
        ...
        model = kwargs.get("model", "Lightricks/LTX-Video-0.9.7-dev")
        model_upsample = kwargs.get("model_upsample", "Lightricks/ltxv-spatial-upscaler-0.9.7")
        demo = create_demo(model=model, model_upsample=model_upsample)
